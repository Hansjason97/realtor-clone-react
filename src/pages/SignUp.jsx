...
import image0 from '../images/realEstate.jpg';
    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form action="" >
          <input type="text" className='w-full mb-6 px-2 py-4 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out' id="name" 
            ...
            <div className='flex justify-between text-sm sm:text-lg'>
              <p className='text-gray-600'>Have an account ?
                <Link to="/sign-in" className='underline ml-1 text-purple-500 hover:text-purple-800'>Sign In</Link>
              </p>
            ...
            hover:bg-purple-700 transition ease-in-out active:bg-purple-800'>Sign up</button>
